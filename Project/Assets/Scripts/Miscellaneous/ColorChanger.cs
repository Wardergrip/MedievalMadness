...
public class ColorChanger : MonoBehaviour
{
    ...
    [Header("Settings")]
    [Tooltip("How long it takes before anyone can change color again")]
    ...
    private void ChangePawnColors()
    {
        ...
        // Change color for each eneterd player
        foreach (var player in _enteredPlayers)
        {
            // Set to next available color
            colorManager.SetAvailablePawnColor(player.PlayerPawn, player.PawnColor);
        }
