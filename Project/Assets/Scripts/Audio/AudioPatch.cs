...
public class AudioPatch : ScriptableObject
{
    ...
    {
        var obj = Instantiate(Resources.Load("TrailingAudioSource") as GameObject, transform.position,transform.rotation);
        obj.GetComponent<DestroyTimer>().Timer = _longestClipTime;
        Play(obj.GetComponent<AudioSource>());
    }
